use modelvault_core::segments::header::{SegmentHeader, SegmentType, SEGMENT_HEADER_LEN};
use modelvault_core::segments::reader::{read_segment_header_at, scan_segments};

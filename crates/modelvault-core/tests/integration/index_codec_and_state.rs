...
fn decode_index_payload_rejects_unexpected_eof_in_tags_and_lengths() {
    ...
    let mut b = Vec::new();
    b.extend_from_slice(&modelvault_core::index::INDEX_PAYLOAD_VERSION_V2.to_le_bytes());
    ...
    let mut b2 = Vec::new();
    b2.extend_from_slice(&modelvault_core::index::INDEX_PAYLOAD_VERSION_V2.to_le_bytes());
    ...
    let mut b3 = Vec::new();
    b3.extend_from_slice(&modelvault_core::index::INDEX_PAYLOAD_VERSION_V2.to_le_bytes());

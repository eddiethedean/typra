...
pub use codec::{
    ...
    CATALOG_PAYLOAD_VERSION, CATALOG_PAYLOAD_VERSION_V1, ENTRY_KIND_CREATE_COLLECTION,
    ENTRY_KIND_NEW_SCHEMA_VERSION, MAX_COLLECTION_NAME_BYTES, MAX_TYPE_NESTING_DEPTH,
};

#!/usr/bin/env python3
"""FastAPI + ModelVault using the asyncio API.
...
DB_PATH = Path(__file__).resolve().parent / "items_async.modelvault"
...
app = FastAPI(title="ModelVault async FastAPI example", lifespan=lifespan)

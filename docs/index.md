...
Package version **0.16.x** on PyPI and crates.io builds on the **1.0 product milestone** (0.14.x rebrand) (see [Compatibility → Versioning](reference/compatibility.md#versioning-package-vs-product)).

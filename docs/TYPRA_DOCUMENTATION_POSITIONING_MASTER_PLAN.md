# Typra Documentation & Positioning Master Plan

# Overview

This document serves as the strategic documentation, positioning, onboarding, marketing, and developer-experience roadmap for Typra.

The goal is to transform Typra from a technically impressive database project into a product that developers immediately understand, evaluate, adopt, and recommend.

Typra 1.0 has reached a level of maturity where technology is no longer the primary challenge.

The primary challenge is positioning.

Many developers who encounter Typra today will ask:

- Why should I use Typra?
- How is Typra different from SQLite?
- Why not just use JSON files?
- Why not use TinyDB?
- Why not use SQLModel?
- Why not use DuckDB?
- What kind of applications is Typra built for?
...
However, it assumes the reader already understands why Typra exists.
...
A new visitor should understand Typra within 30 seconds.
...
# New Documentation Section: Why Typra

Create:

docs/guides/why_typra.md
...
When not to use Typra

---

# New Documentation Section: Typra vs SQLite
...
# New Documentation Section: Typra vs JSON Files
...
# New Documentation Section: Typra vs TinyDB
...
# New Documentation Section: Typra vs DuckDB
...
"Typra is the easiest database for small FastAPI applications."
...
"Typra feels like a natural extension of Pydantic."
...
Users understand Typra in under 30 seconds.

Users can store their first model within 5 minutes.

Users can compare Typra to SQLite within 10 minutes.
...
The ideal future perception of Typra is:

"When I need a database for application models, I use Typra."

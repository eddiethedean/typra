...
Blog drafts live under **`blog/`** — see [modelvault-for-application-models.md](https://github.com/eddiethedean/modelvault/blob/main/blog/modelvault-for-application-models.md).

Positioning docs: [Why ModelVault](../guides/why_modelvault.md), [Comparisons](../comparisons/index.md). Page levels and checklist: [Documentation map](documentation_map.md). Full editorial plan: `docs/MODELVAULT_DOCUMENTATION_POSITIONING_MASTER_PLAN.md` on GitHub.
...
CI runs benches weekly (non-blocking). See [bench workflow on GitHub](https://github.com/eddiethedean/modelvault/blob/main/.github/workflows/bench.yml).

## Coverage

- **Rust**: `cargo llvm-cov` — practical 100% line coverage goal for `modelvault-core` with documented exclusions
...
GitHub Actions [publish workflow](https://github.com/eddiethedean/modelvault/blob/main/.github/workflows/publish.yml) runs on `v*.*.*` tags.
...
[`.github/workflows/ci.yml`](https://github.com/eddiethedean/modelvault/blob/main/.github/workflows/ci.yml) — Rust + Python + docs + coverage.
...
| Roadmap | [ROADMAP on GitHub](https://github.com/eddiethedean/modelvault/blob/main/ROADMAP.md) |
| Full contributing notes (repo root) | [contributing.md on GitHub](https://github.com/eddiethedean/modelvault/blob/main/docs/contributing.md) |

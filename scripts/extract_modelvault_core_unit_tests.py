#!/usr/bin/env python3
"""Extract #[cfg(test)] mod blocks from modelvault-core sources into tests/unit/*.rs for include!."""
...
def unit_filename(src_rel: Path, mod_name: str) -> str:
    """src_rel is relative to modelvault-core/, e.g. Path('src/checkpoint.rs')."""
...
def main() -> None:
    core = Path("crates/modelvault-core")
    src_root = core / "src"
